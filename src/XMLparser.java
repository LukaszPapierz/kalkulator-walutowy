...
public class XMLparser 
{
	...
	ArrayList<GPW> GPW = new ArrayList<GPW>();
        private String backupPath = "data-source\\backup.xml";
        private String metalPath = "data-source\\metal.xml";
        private String gpwPath = "data-source\\gpw.html";
	...
	{
	    this.download(this.backupPath, "currency");
	}
	...
	public void updateCurrency()
	{
		...
		try {
			...
			Document doc = db.parse(this.backupPath);
	...
	{
		this.download(this.metalPath, "metal");
	}
	...
	public void updateMetal()
	{
		try {
		    ...
		    DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
			DocumentBuilder db = dbf.newDocumentBuilder();
			Document doc = db.parse(this.metalPath);
	...
	{
		this.download(this.gpwPath, "gpw");
	}
	
	public void updateGPW() 
	{
		File in = new File(this.gpwPath);
